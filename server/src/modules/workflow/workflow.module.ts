...
import { WorkflowRunController, WorkflowBulkRunController } from './workflow-run.controller';
...
@Module({
  ...
  controllers: [WorkflowController, WorkflowRunController, WorkflowBulkRunController],
